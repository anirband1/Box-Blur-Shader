...
// settings
const unsigned int SCR_WIDTH = 580;
const unsigned int SCR_HEIGHT = 772;
...
#pragma endregion
    ...
    imgToTexID("media/planets.jpeg", &texture1, GL_REPEAT);
...
void processInput(GLFWwindow *window)
{
    ...
    if (glfwGetKey(window, GLFW_KEY_DOWN) == GLFW_PRESS)
        kernelSize = clamp(kernelSize - 1, 0, 10000);
}
